...
import { UserPlus, Globe, Plane, MapPin, Calendar, Users, Sparkles, Star } from 'lucide-react';
...
const FlightPath = () => (
  <svg className="absolute inset-0 w-full h-full pointer-events-none" viewBox="0 0 800 600"
    ...
    <defs>
      <linearGradient id="sp-trail" x1="0" y1="0" x2="1" y2="1">
    ...
    <motion.path
      ...
      stroke="url(#sp-trail)" strokeWidth="1.5"
    ...
    <motion.path
      ...
      stroke="url(#sp-trail)" strokeWidth="1"
...
const SignupPage = () => {
  ...
  const handleGoogleSignup = () => {
    // Record signup intent so callback can provide contextual feedback
  ...
  const perks = [
    { Icon: MapPin,   label: 'Curated Itineraries' },
    { Icon: Calendar, label: 'Instant Booking' },
    { Icon: Users,    label: 'AI Travel Agent' },
  ];
          ...
          <div className="relative z-10 p-8 md:p-10">
            ...
            >
              ...
              <p className="text-[#57534E] text-base">
                Sign up in seconds to start planning your dream vacation
              </p>
            </motion.div>
            ...
            >
              <button
                data-testid={AUTH.googleSignupButton}
              ...
              >
                ...
                <UserPlus size={18} className="relative z-10 ml-auto text-[#57534E] group-hover:text-white transition-colors duration-300" />
              </button>
            </motion.div>
            ...
            <div className="mt-4 text-center">
              <p className="text-sm text-[#57534E]">
                ...
                <Link to="/login" className="text-[#C47245] font-semibold hover:underline">
                  Log in
                </Link>
              </p>
            </div>
            ...
            >
              ...
              <span className="text-xs uppercase tracking-[0.2em] text-[#57534E]">Fast & Free</span>
              <div className="flex-1 h-px bg-[#E7E5E4]" />
            </motion.div>
