...
# Also need to close the else block — find the logger line after flight_stops
OLD2 = '''            flight_stops    = af['stops']'''
# We need the full try/except to close properly
# Find what comes right after the flight fetch try block
import re
...
if OLD in content:
    ...
    print("PATCH 1 FAILED - dumping first 50 chars of target area for debug")
